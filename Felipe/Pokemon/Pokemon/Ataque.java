...
public class Ataque {
	...
	public Ataque(int potencia, String tipoAtaque, String tipoDaño, int pP, int precision, boolean prioridad,
			double chanceVeneno, double chanceParalisis, double chanceQuemar, double chanceDormir,
			double chanceConfundir, double chanceCongelar, double multbuff, double multdebuff) {
